...
class PageFeedItemServiceReviewSummarySelector implements ModelInterface, ArrayAccess
{
     ...
     * Sets feedIds
     *
     * @param int[]|null $feedIds <div lang=\"ja\">フィードID</div><div lang=\"en\">Feed ID</div>
     *
     * @return $this
     */
    ...
    public function setNumberResults($numberResults)
    {
        ...
        if (!is_null($numberResults) && ($numberResults > 10000)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling PageFeedItemServiceReviewSummarySelector., must be smaller than or equal to 10000.');
        }
        if (!is_null($numberResults) && ($numberResults < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling PageFeedItemServiceReviewSummarySelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($startIndex)
    {
        ...
        if (!is_null($startIndex) && ($startIndex < 1)) {
            throw new \InvalidArgumentException('invalid value for $startIndex when calling PageFeedItemServiceReviewSummarySelector., must be bigger than or equal to 1.');
        }
