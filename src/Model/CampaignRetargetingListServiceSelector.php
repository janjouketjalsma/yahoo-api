...
class CampaignRetargetingListServiceSelector implements ModelInterface, ArrayAccess
{
     ...
     * Sets accountId
     *
     * @param int $accountId <div lang=\"ja\">アカウントIDです。</div><div lang=\"en\">Search conditon: Account ID.</div>
     *
     * @return $this
     */
     ...
     * Sets campaignIds
     *
     * @param int[]|null $campaignIds <div lang=\"ja\">キャンペーンIDです。</div><div lang=\"en\">Search conditon: Campaign ID.</div>
     *
     * @return $this
     */
    ...
    public function setNumberResults($numberResults)
    {
        ...
        if (!is_null($numberResults) && ($numberResults > 1000)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling CampaignRetargetingListServiceSelector., must be smaller than or equal to 1000.');
        }
        if (!is_null($numberResults) && ($numberResults < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling CampaignRetargetingListServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($startIndex)
    {
        ...
        if (!is_null($startIndex) && ($startIndex < 1)) {
            throw new \InvalidArgumentException('invalid value for $startIndex when calling CampaignRetargetingListServiceSelector., must be bigger than or equal to 1.');
        }
     ...
     * Sets targetListIds
     *
     * @param int[]|null $targetListIds <div lang=\"ja\">ターゲットリストIDです。</div><div lang=\"en\">Search conditon: Target List ID.</div>
     *
     * @return $this
     */
