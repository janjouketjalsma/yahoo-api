...
class CampaignFeedServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'feedItemIds' => 'int[]',
        'numberResults' => 'int',
        'placeholderTypes' => '\Yahoo\Model\CampaignFeedServicePlaceholderType[]',
        'startIndex' => 'int'
    ];
    ...
    public function setNumberResults($numberResults)
    {
        ...
        if (!is_null($numberResults) && ($numberResults > 500)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling CampaignFeedServiceSelector., must be smaller than or equal to 500.');
        }
        if (!is_null($numberResults) && ($numberResults < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling CampaignFeedServiceSelector., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param \Yahoo\Model\CampaignFeedServicePlaceholderType[]|null $placeholderTypes placeholderTypes
     *
     * @return $this
     */
    ...
    public function setStartIndex($startIndex)
    {
        ...
        if (!is_null($startIndex) && ($startIndex < 1)) {
            throw new \InvalidArgumentException('invalid value for $startIndex when calling CampaignFeedServiceSelector., must be bigger than or equal to 1.');
        }
