 ...
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;RetargetingListServiceSelectorは、ターゲットリストの検索条件（実行パラメータ）を保持するオブジェクトです。&lt;/div&gt;&lt;div lang&#x3D;\&quot;en\&quot;&gt;RetargetingListServiceSelector is an object that holds search condition (parameter).&lt;/div&gt;
 * @package  Yahoo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RetargetingListServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'targetListTypes' => '\Yahoo\Model\RetargetingListServiceTargetListType[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'targetListTypes' => 'targetListTypes'
    ];
    ...
    protected static $setters = [
        ...
        'targetListTypes' => 'setTargetListTypes'
    ];
    ...
    protected static $getters = [
        ...
        'targetListTypes' => 'getTargetListTypes'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['targetListTypes'] = isset($data['targetListTypes']) ? $data['targetListTypes'] : null;
    }
     ...
     * Sets accountId
     *
     * @param int $accountId <div lang=\"ja\">検索条件：アカウントIDです。</div><div lang=\"en\">Search conditon: Account ID.</div>
     *
     * @return $this
     */
    ...
    public function setNumberResults($numberResults)
    {
        ...
        if (!is_null($numberResults) && ($numberResults > 1000)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling RetargetingListServiceSelector., must be smaller than or equal to 1000.');
        }
        if (!is_null($numberResults) && ($numberResults < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling RetargetingListServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($startIndex)
    {
        ...
        if (!is_null($startIndex) && ($startIndex < 1)) {
            throw new \InvalidArgumentException('invalid value for $startIndex when calling RetargetingListServiceSelector., must be bigger than or equal to 1.');
        }
     ...
     * Sets targetListIds
     *
     * @param int[]|null $targetListIds <div lang=\"ja\">検索条件：ターゲットリストIDです。</div><div lang=\"en\">Search conditon: Target List ID.</div>
     *
     * @return $this
     */
    ...
    /**
     * Gets targetListTypes
     *
     * @return \Yahoo\Model\RetargetingListServiceTargetListType[]|null
     */
    public function getTargetListTypes()
    {
        return $this->container['targetListTypes'];
    }

    /**
     * Sets targetListTypes
     *
     * @param \Yahoo\Model\RetargetingListServiceTargetListType[]|null $targetListTypes targetListTypes
     *
     * @return $this
     */
    public function setTargetListTypes($targetListTypes)
    {
        $this->container['targetListTypes'] = $targetListTypes;
