...
/**
 * OfflineConversionServiceSelector Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;OfflineConversionServiceSelectorオブジェクトは、登録したオフラインコンバージョンデータを照会するための検索条件を格納します。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;OfflineConversionServiceSelector object contains search condition to inquire about registered offline conversion data.&lt;/div&gt;
 * @package  Yahoo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class OfflineConversionServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfflineConversionServiceSelector';
    ...
    protected static $openAPITypes = [
        'accountId' => 'int',
        'uploadIds' => 'int[]',
        'sorts' => '\Yahoo\Model\OfflineConversionServiceSort[]',
        'numberResults' => 'int',
        'startIndex' => 'int'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['uploadIds'] = isset($data['uploadIds']) ? $data['uploadIds'] : null;
    ...
    {
        return $this->container['uploadIds'];
    }

    /**
     * Sets uploadIds
     *
     * @param int[]|null $uploadIds <div lang=\"ja\">検索条件：アップロードIDです。</div> <div lang=\"en\">Search conditon: Upload ID.</div>
     *
     * @return $this
     */
    public function setUploadIds($uploadIds)
    {
        $this->container['uploadIds'] = $uploadIds;
     ...
     * Gets sorts
     *
     * @return \Yahoo\Model\OfflineConversionServiceSort[]|null
     */
     ...
     * Sets sorts
     *
     * @param \Yahoo\Model\OfflineConversionServiceSort[]|null $sorts sorts
     *
     * @return $this
     */
    ...
    public function setNumberResults($numberResults)
    {
        ...
        if (!is_null($numberResults) && ($numberResults > 1000)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling OfflineConversionServiceSelector., must be smaller than or equal to 1000.');
        }
        if (!is_null($numberResults) && ($numberResults < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling OfflineConversionServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($startIndex)
    {
        ...
        if (!is_null($startIndex) && ($startIndex < 1)) {
            throw new \InvalidArgumentException('invalid value for $startIndex when calling OfflineConversionServiceSelector., must be bigger than or equal to 1.');
        }
