 ...
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;BalanceSelectorオブジェクトは、アカウント残高を取得するアカウントを示します。&lt;/div&gt;&lt;div lang&#x3D;\&quot;en\&quot;&gt;Explains its account balance.&lt;/div&gt;
 * @package  Yahoo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class BalanceServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accountIds'] === null) {
            $invalidProperties[] = "'accountIds' can't be null";
        }
     ...
     * Sets accountIds
     *
     * @param int[] $accountIds <div lang=\"ja\">アカウントIDの配列です。</div><div lang=\"en\">Account IDs.</div>
     *
     * @return $this
     */
    ...
    public function setNumberResults($numberResults)
    {
        ...
        if (!is_null($numberResults) && ($numberResults > 200)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling BalanceServiceSelector., must be smaller than or equal to 200.');
        }
        if (!is_null($numberResults) && ($numberResults < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling BalanceServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($startIndex)
    {
        ...
        if (!is_null($startIndex) && ($startIndex < 1)) {
            throw new \InvalidArgumentException('invalid value for $startIndex when calling BalanceServiceSelector., must be bigger than or equal to 1.');
        }
