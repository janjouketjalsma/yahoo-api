...
/**
 * AdGroupWebpageServiceSelector Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;AdGroupWebpageServiceSelectorオブジェクトは、取得する条件を保持します。&lt;/div&gt;&lt;div lang&#x3D;\&quot;en\&quot;&gt;AdGroupWebpageServiceSelector object contains the rules to be acquired.&lt;/div&gt;
 * @package  Yahoo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AdGroupWebpageServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdGroupWebpageServiceSelector';
     ...
     * Sets adGroupIds
     *
     * @param int[]|null $adGroupIds <div lang=\"ja\">広告グループID</div><div lang=\"en\">AdGroup ID</div>
     *
     * @return $this
     */
    ...
    public function setNumberResults($numberResults)
    {
        ...
        if (!is_null($numberResults) && ($numberResults > 2000)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling AdGroupWebpageServiceSelector., must be smaller than or equal to 2000.');
        }
        if (!is_null($numberResults) && ($numberResults < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling AdGroupWebpageServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($startIndex)
    {
        ...
        if (!is_null($startIndex) && ($startIndex < 1)) {
            throw new \InvalidArgumentException('invalid value for $startIndex when calling AdGroupWebpageServiceSelector., must be bigger than or equal to 1.');
        }
     ...
     * Sets targetIds
     *
     * @param int[]|null $targetIds <div lang=\"ja\">配信/除外設定を識別するID</div><div lang=\"en\">Unique ID to identify &#39;Allow&#39; or &#39;Exclude&#39; settings</div>
     *
     * @return $this
     */
