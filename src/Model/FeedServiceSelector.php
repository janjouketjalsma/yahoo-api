 ...
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;FeedServiceSelectorオブジェクトは、自動データ挿入のリストの基本情報を格納します。&lt;/div&gt;&lt;div lang&#x3D;\&quot;en\&quot;&gt;FeedServiceSelector describes the basic information of list of Data auto insertion.&lt;/div&gt;
 * @package  Yahoo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class FeedServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'feedIds' => 'int[]',
        'numberResults' => 'int',
        'placeholderTypes' => '\Yahoo\Model\FeedServicePlaceholderType[]',
        'startIndex' => 'int'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['numberResults'] = isset($data['numberResults']) ? $data['numberResults'] : 50;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['numberResults']) && ($this->container['numberResults'] > 50)) {
            $invalidProperties[] = "invalid value for 'numberResults', must be smaller than or equal to 50.";
        }
     ...
     * Sets feedIds
     *
     * @param int[]|null $feedIds <div lang=\"ja\">自動データ挿入のリストのIDです。</div><div lang=\"en\">List ID of Feed.</div>
     *
     * @return $this
     */
    ...
    public function setNumberResults($numberResults)
    {
        ...
        if (!is_null($numberResults) && ($numberResults > 50)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling FeedServiceSelector., must be smaller than or equal to 50.');
        }
        if (!is_null($numberResults) && ($numberResults < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling FeedServiceSelector., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param \Yahoo\Model\FeedServicePlaceholderType[]|null $placeholderTypes placeholderTypes
     *
     * @return $this
     */
    ...
    public function setStartIndex($startIndex)
    {
        ...
        if (!is_null($startIndex) && ($startIndex < 1)) {
            throw new \InvalidArgumentException('invalid value for $startIndex when calling FeedServiceSelector., must be bigger than or equal to 1.');
        }
