 ...
 * @link     https://openapi-generator.tech
 */
class CampaignServiceDynamicAdsForSearchSetting implements ModelInterface, ArrayAccess
{
     ...
     * Sets feedIds
     *
     * @param int[]|null $feedIds <div lang=\"ja\">キャンペーンで使用するページフィードIDです。<br>ADD時およびSET時、このフィールドは必須となります。 </div><div lang=\"en\">Page Feed ID for campaign.<br>This field is required in ADD and SET operation. </div>
     *
     * @return $this
     */
