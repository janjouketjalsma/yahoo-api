 ...
 * @link     https://openapi-generator.tech
 */
class CampaignExportServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'accountId' => 'int',
        'jobIds' => 'int[]',
        'jobStatuses' => '\Yahoo\Model\CampaignExportServiceJobStatus[]',
        'numberResults' => 'int',
        'startIndex' => 'int'
    ];
     ...
     * Sets jobIds
     *
     * @param int[]|null $jobIds <div lang=\"ja\">検索条件：ジョブIDです。</div><div lang=\"en\">Search condition: Job ID.</div>
     *
     * @return $this
     */
     ...
     * Sets jobStatuses
     *
     * @param \Yahoo\Model\CampaignExportServiceJobStatus[]|null $jobStatuses jobStatuses
     *
     * @return $this
     */
    ...
    public function setNumberResults($numberResults)
    {
        ...
        if (!is_null($numberResults) && ($numberResults > 500)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling CampaignExportServiceSelector., must be smaller than or equal to 500.');
        }
        if (!is_null($numberResults) && ($numberResults < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling CampaignExportServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($startIndex)
    {
        ...
        if (!is_null($startIndex) && ($startIndex < 1)) {
            throw new \InvalidArgumentException('invalid value for $startIndex when calling CampaignExportServiceSelector., must be bigger than or equal to 1.');
        }
