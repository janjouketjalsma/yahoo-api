 ...
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;AdGroupFeedServiceListオブジェクトは、広告グループに関連付けられたFeedItem情報を表します。&lt;/div&gt;&lt;div lang&#x3D;\&quot;en\&quot;&gt;AdGroupFeedServiceList object describes the FeedItem information connected to ad group.&lt;/div&gt;
 * @package  Yahoo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AdGroupFeedServiceList implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'accountId' => 'int',
        'adGroupFeed' => '\Yahoo\Model\AdGroupFeed[]',
        'adGroupId' => 'int',
        'campaignId' => 'int',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['adGroupFeed'] = isset($data['adGroupFeed']) ? $data['adGroupFeed'] : null;
     ...
     * Gets adGroupFeed
     *
     * @return \Yahoo\Model\AdGroupFeed[]|null
     */
    public function getAdGroupFeed()
    {
        return $this->container['adGroupFeed'];
    }

    /**
     * Sets adGroupFeed
     *
     * @param \Yahoo\Model\AdGroupFeed[]|null $adGroupFeed adGroupFeed
     *
     * @return $this
     */
    public function setAdGroupFeed($adGroupFeed)
    {
        $this->container['adGroupFeed'] = $adGroupFeed;
     ...
     * Sets adGroupId
     *
     * @param int|null $adGroupId <div lang=\"ja\">広告グループIDです。<br>SET時、このフィールドは必須となります。</div><div lang=\"en\">Ad Group ID.<br>This field is required in SET operation.</div>
     *
     * @return $this
     */
     ...
     * Sets campaignId
     *
     * @param int|null $campaignId <div lang=\"ja\">キャンペーンIDです。<br>SET時、このフィールドは必須となります。</div><div lang=\"en\">Campaign ID.<br>This field is required in SET operation.</div>
     *
     * @return $this
     */
