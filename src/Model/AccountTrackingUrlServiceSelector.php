...
/**
 * AccountTrackingUrlServiceSelector Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class AccountTrackingUrlServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountTrackingUrlServiceSelector';
     ...
     * Sets accountIds
     *
     * @param int[]|null $accountIds <div lang=\"ja\">検索条件：アカウントIDです。</div><div lang=\"en\">Search condition: Account ID.</div>
     *
     * @return $this
     */
    ...
    public function setNumberResults($numberResults)
    {
        ...
        if (!is_null($numberResults) && ($numberResults > 1000)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling AccountTrackingUrlServiceSelector., must be smaller than or equal to 1000.');
        }
        if (!is_null($numberResults) && ($numberResults < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling AccountTrackingUrlServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($startIndex)
    {
        ...
        if (!is_null($startIndex) && ($startIndex < 1)) {
            throw new \InvalidArgumentException('invalid value for $startIndex when calling AccountTrackingUrlServiceSelector., must be bigger than or equal to 1.');
        }
