...
/**
 * AdGroupCriterionServiceAdditionalUrl Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class AdGroupCriterionServiceAdditionalUrl implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdGroupCriterionServiceAdditionalUrl';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['reviewUrl'] = isset($data['reviewUrl']) ? $data['reviewUrl'] : null;
     ...
     *
     * @param string[]|null $disapprovalReasonCodes <div lang=\"ja\">審査否認理由のコードです。<br>(コード詳細は、DictionaryServiceのgetDisapprovalReasonのレスポンスを参照)<br>このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。</div><div lang=\"en\">Reject reason code.<br>(Refer to DictionaryService getDisapprovalReason response for details) <br>Although this field will be returned in the response, it will be ignored on input. </div>
     *
     * @return $this
     */
    ...
    {
        return $this->container['reviewUrl'];
    }

    /**
     * Sets reviewUrl
     *
     * @param string|null $reviewUrl <div lang=\"ja\">審査中の最終リンク先URLです。<br>このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。</div><div lang=\"en\">Landing Page URL in editorial review.<br>Although this field will be returned in the response, it will be ignored on input. </div>
     *
     * @return $this
     */
    public function setReviewUrl($reviewUrl)
    {
        $this->container['reviewUrl'] = $reviewUrl;
     ...
     * Sets url
     *
     * @param string|null $url <div lang=\"ja\">最終リンク先URLです。<br>ADDおよびSET時、このフィールドは必須となります。</div><div lang=\"en\">Landing Page URL.<br>This field is required in ADD and SET operation.</div>
     *
     * @return $this
     */
