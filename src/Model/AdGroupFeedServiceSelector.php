...
/**
 * AdGroupFeedServiceSelector Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;AdGroupFeedServiceSelectorオブジェクトは、FeedItem情報を指定します。&lt;/div&gt;&lt;div lang&#x3D;\&quot;en\&quot;&gt;AdGroupFeedServiceSelector describes the FeedItem information.&lt;/div&gt;
 * @package  Yahoo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AdGroupFeedServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdGroupFeedServiceSelector';
    ...
    protected static $openAPITypes = [
        ...
        'feedItemIds' => 'int[]',
        'numberResults' => 'int',
        'placeholderTypes' => '\Yahoo\Model\AdGroupFeedServicePlaceholderType[]',
        'startIndex' => 'int'
    ];
     ...
     * Sets feedItemIds
     *
     * @param int[]|null $feedItemIds <div lang=\"ja\">FeedItem情報のIDです。</div><div lang=\"en\">FeedItem information ID.</div>
     *
     * @return $this
     */
    ...
    public function setNumberResults($numberResults)
    {
        ...
        if (!is_null($numberResults) && ($numberResults > 500)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling AdGroupFeedServiceSelector., must be smaller than or equal to 500.');
        }
        if (!is_null($numberResults) && ($numberResults < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling AdGroupFeedServiceSelector., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param \Yahoo\Model\AdGroupFeedServicePlaceholderType[]|null $placeholderTypes placeholderTypes
     *
     * @return $this
     */
    ...
    public function setStartIndex($startIndex)
    {
        ...
        if (!is_null($startIndex) && ($startIndex < 1)) {
            throw new \InvalidArgumentException('invalid value for $startIndex when calling AdGroupFeedServiceSelector., must be bigger than or equal to 1.');
        }
