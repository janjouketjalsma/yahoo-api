 ...
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;AuditLogServiceSelectorオブジェクトは、登録したジョブを照会するための検索条件を保持します。&lt;/div&gt;&lt;div lang&#x3D;\&quot;en\&quot;&gt;AuditLogServiceSelector object retains search criterias to inquire a created job.&lt;/div&gt;
 * @package  Yahoo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AuditLogServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'accountId' => 'int',
        'jobIds' => 'int[]',
        'jobStatuses' => '\Yahoo\Model\AuditLogServiceJobStatus[]',
        'numberResults' => 'int',
        'startIndex' => 'int'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['jobStatuses'] = isset($data['jobStatuses']) ? $data['jobStatuses'] : null;
     ...
     * Sets jobIds
     *
     * @param int[]|null $jobIds <div lang=\"ja\">登録したジョブのIDです。</div><div lang=\"en\">Created job ID</div>
     *
     * @return $this
     */
    ...
    {
        return $this->container['jobStatuses'];
    }

    /**
     * Sets jobStatuses
     *
     * @param \Yahoo\Model\AuditLogServiceJobStatus[]|null $jobStatuses jobStatuses
     *
     * @return $this
     */
    public function setJobStatuses($jobStatuses)
    {
        $this->container['jobStatuses'] = $jobStatuses;
    ...
    public function setNumberResults($numberResults)
    {
        ...
        if (!is_null($numberResults) && ($numberResults > 1000)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling AuditLogServiceSelector., must be smaller than or equal to 1000.');
        }
        if (!is_null($numberResults) && ($numberResults < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling AuditLogServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($startIndex)
    {
        ...
        if (!is_null($startIndex) && ($startIndex < 1)) {
            throw new \InvalidArgumentException('invalid value for $startIndex when calling AuditLogServiceSelector., must be bigger than or equal to 1.');
        }
