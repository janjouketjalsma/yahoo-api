 ...
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;CampaignFeedオブジェクトは、キャンペーンに紐づけられたFeedItem情報を表します。&lt;br&gt;SET時、このフィールドは必須です。&lt;/div&gt;&lt;div lang&#x3D;\&quot;en\&quot;&gt;CampaignFeed describes FeedItem information connected to campaign.&lt;br&gt;This field is required in SET operation. &lt;/div&gt;
 * @package  Yahoo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CampaignFeed implements ModelInterface, ArrayAccess
{
     ...
     * Sets feedItemId
     *
     * @param int|null $feedItemId <div lang=\"ja\">FeedItem情報のIDです。<br>SET時、このフィールドは必須です。</div><div lang=\"en\">FeedItem information ID.<br>This field is required in SET operation. </div>
     *
     * @return $this
     */
