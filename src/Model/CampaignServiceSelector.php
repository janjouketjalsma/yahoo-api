 ...
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;CampaignServiceSelectorオブジェクトは、操作の対象とするキャンペーンの情報およびフィルタ条件を表します。&lt;/div&gt;&lt;div lang&#x3D;\&quot;en\&quot;&gt;CampaignServiceSelector object displays information and filter criteria of campaign to be operated.&lt;/div&gt;
 * @package  Yahoo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CampaignServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'campaignIds' => 'int[]',
        'containsLabelId' => '\Yahoo\Model\CampaignServiceContainsLabelId',
        'labelIds' => 'int[]',
        'numberResults' => 'int',
        'startIndex' => 'int',
        'userStatuses' => '\Yahoo\Model\CampaignServiceUserStatus[]'
    ];
     ...
     *
     * @param int[]|null $biddingStrategyIds <div lang=\"ja\">検索条件：自動入札IDです。</div><div lang=\"en\">Search condition: Auto Bidding ID.</div>
     *
     * @return $this
     */
     ...
     * Sets campaignIds
     *
     * @param int[]|null $campaignIds <div lang=\"ja\">検索条件：キャンペーンIDです。<br>※指定しない場合は、フィルタ条件に すべてのキャンペーンが含まれます。</div><div lang=\"en\">Search condition: Campaign ID<br>* All campaign will return, if no campaign are not specified.</div>
     *
     * @return $this
     */
     ...
     *
     * @return \Yahoo\Model\CampaignServiceContainsLabelId|null
     */
     ...
     *
     * @param \Yahoo\Model\CampaignServiceContainsLabelId|null $containsLabelId containsLabelId
     *
     * @return $this
     */
     ...
     * Sets labelIds
     *
     * @param int[]|null $labelIds <div lang=\"ja\">検索条件：ラベルIDです。</div><div lang=\"en\">Search condition: Label ID.</div>
     *
     * @return $this
     */
    ...
    public function setNumberResults($numberResults)
    {
        ...
        if (!is_null($numberResults) && ($numberResults > 10000)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling CampaignServiceSelector., must be smaller than or equal to 10000.');
        }
        if (!is_null($numberResults) && ($numberResults < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling CampaignServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($startIndex)
    {
        ...
        if (!is_null($startIndex) && ($startIndex < 1)) {
            throw new \InvalidArgumentException('invalid value for $startIndex when calling CampaignServiceSelector., must be bigger than or equal to 1.');
        }
     ...
     * Sets userStatuses
     *
     * @param \Yahoo\Model\CampaignServiceUserStatus[]|null $userStatuses userStatuses
     *
     * @return $this
     */
