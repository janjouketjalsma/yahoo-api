...
/**
 * AccountSharedServiceSelector Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;AccountSharedServiceSelectorオブジェクトは、検索条件（実行パラメータ）を保持します。&lt;/div&gt;&lt;div lang&#x3D;\&quot;en\&quot;&gt;AccountSharedServiceSelector object holds search criteria (exec parameter).&lt;/div&gt;
 * @package  Yahoo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AccountSharedServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountSharedServiceSelector';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['numberResults'] = isset($data['numberResults']) ? $data['numberResults'] : 20;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['numberResults']) && ($this->container['numberResults'] > 20)) {
            $invalidProperties[] = "invalid value for 'numberResults', must be smaller than or equal to 20.";
        }
    ...
    public function setNumberResults($numberResults)
    {
        ...
        if (!is_null($numberResults) && ($numberResults > 20)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling AccountSharedServiceSelector., must be smaller than or equal to 20.');
        }
        if (!is_null($numberResults) && ($numberResults < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling AccountSharedServiceSelector., must be bigger than or equal to 1.');
        }
     ...
     * Sets sharedListIds
     *
     * @param int[]|null $sharedListIds <div lang=\"ja\">検索対象外キーワードリストIDです。</div><div lang=\"en\">Negative keyword list ID.</div>
     *
     * @return $this
     */
    ...
    public function setStartIndex($startIndex)
    {
        ...
        if (!is_null($startIndex) && ($startIndex < 1)) {
            throw new \InvalidArgumentException('invalid value for $startIndex when calling AccountSharedServiceSelector., must be bigger than or equal to 1.');
        }
