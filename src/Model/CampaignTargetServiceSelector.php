 ...
 * @link     https://openapi-generator.tech
 */
class CampaignTargetServiceSelector implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'numberResults' => 'int',
        'platformTypes' => '\Yahoo\Model\CampaignTargetServicePlatformType[]',
        'startIndex' => 'int',
        'targetIds' => 'string[]',
        'targetTypes' => '\Yahoo\Model\CampaignTargetServiceTargetType[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['targetTypes'] = isset($data['targetTypes']) ? $data['targetTypes'] : null;
    }
    ...
    public function setNumberResults($numberResults)
    {
        ...
        if (!is_null($numberResults) && ($numberResults > 500)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling CampaignTargetServiceSelector., must be smaller than or equal to 500.');
        }
        if (!is_null($numberResults) && ($numberResults < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling CampaignTargetServiceSelector., must be bigger than or equal to 1.');
        }
     ...
     * Gets platformTypes
     *
     * @return \Yahoo\Model\CampaignTargetServicePlatformType[]|null
     */
     ...
     * Sets platformTypes
     *
     * @param \Yahoo\Model\CampaignTargetServicePlatformType[]|null $platformTypes platformTypes
     *
     * @return $this
     */
    ...
    public function setStartIndex($startIndex)
    {
        ...
        if (!is_null($startIndex) && ($startIndex < 1)) {
            throw new \InvalidArgumentException('invalid value for $startIndex when calling CampaignTargetServiceSelector., must be bigger than or equal to 1.');
        }
     ...
     * Sets targetIds
     *
     * @param string[]|null $targetIds <div lang=\"ja\">ターゲットIDです。</div><div lang=\"en\">Target ID.</div>
     *
     * @return $this
     */
    ...
    {
        return $this->container['targetTypes'];
    }

    /**
     * Sets targetTypes
     *
     * @param \Yahoo\Model\CampaignTargetServiceTargetType[]|null $targetTypes targetTypes
     *
     * @return $this
     */
    public function setTargetTypes($targetTypes)
    {
        $this->container['targetTypes'] = $targetTypes;
