 ...
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;CampaignCriterionServiceSelectorオブジェクトは、操作の対象となるキャンペーンのクライテリアを表します。&lt;/div&gt;&lt;div lang&#x3D;\&quot;en\&quot;&gt;CampaignCriterionServiceSelector object describes campaign criteria for operation.&lt;/div&gt;
 * @package  Yahoo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CampaignCriterionServiceSelector implements ModelInterface, ArrayAccess
{
     ...
     * Sets campaignIds
     *
     * @param int[]|null $campaignIds <div lang=\"ja\">キャンペーンIDの配列です。</div><div lang=\"en\">Campaign ID array.</div>
     *
     * @return $this
     */
     ...
     * Sets criterionIds
     *
     * @param int[]|null $criterionIds <div lang=\"ja\">クライテリオンIDの配列です。<br>指定しない場合は、キャンペーンID以下のすべてのクライテリアが含まれます。</div><div lang=\"en\">Criterion ID array.<br>If no criterionIds, all of criterionIds under the campaign ID are returned.</div>
     *
     * @return $this
     */
    ...
    public function setNumberResults($numberResults)
    {
        ...
        if (!is_null($numberResults) && ($numberResults > 10000)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling CampaignCriterionServiceSelector., must be smaller than or equal to 10000.');
        }
        if (!is_null($numberResults) && ($numberResults < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling CampaignCriterionServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($startIndex)
    {
        ...
        if (!is_null($startIndex) && ($startIndex < 1)) {
            throw new \InvalidArgumentException('invalid value for $startIndex when calling CampaignCriterionServiceSelector., must be bigger than or equal to 1.');
        }
