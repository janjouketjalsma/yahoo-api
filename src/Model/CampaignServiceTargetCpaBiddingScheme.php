 ...
 * @link     https://openapi-generator.tech
 */
class CampaignServiceTargetCpaBiddingScheme implements ModelInterface, ArrayAccess
{
     ...
     * Sets targetCpa
     *
     * @param int|null $targetCpa <div lang=\"ja\">コンバージョン単価の目標値です。<br>ADD時およびSET時、このフィールドは必須となります。 <br>※制限値：0 ～ 99999999<br>※日本円のみの設定です。</div><div lang=\"en\">Target CPA (JPY).<br>This field is required in ADD and SET operation. <br>* Range limit: 0 - 99999999</div>
     *
     * @return $this
     */
