 ...
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;PageFeedItemServiceJobStatusSelectorオブジェクトは、upload、downloadの処理状況を取得するための検索条件を格納します。&lt;/div&gt;&lt;div lang&#x3D;\&quot;en\&quot;&gt;PageFeedItemServiceJobStatusSelector object retains search condition for The processing situation upload/download.&lt;/div&gt;
 * @package  Yahoo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PageFeedItemServiceJobStatusSelector implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'accountId' => 'int',
        'jobIds' => 'int[]',
        'jobType' => '\Yahoo\Model\PageFeedItemServiceJobType',
        'numberResults' => 'int',
        'startIndex' => 'int'
    ];
     ...
     * Sets jobIds
     *
     * @param int[]|null $jobIds <div lang=\"ja\">登録したジョブのID</div><div lang=\"en\">Registered job ID</div>
     *
     * @return $this
     */
     ...
     * Gets jobType
     *
     * @return \Yahoo\Model\PageFeedItemServiceJobType
     */
     ...
     * Sets jobType
     *
     * @param \Yahoo\Model\PageFeedItemServiceJobType $jobType jobType
     *
     * @return $this
     */
    ...
    public function setNumberResults($numberResults)
    {
        ...
        if (!is_null($numberResults) && ($numberResults > 10000)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling PageFeedItemServiceJobStatusSelector., must be smaller than or equal to 10000.');
        }
        if (!is_null($numberResults) && ($numberResults < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberResults when calling PageFeedItemServiceJobStatusSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($startIndex)
    {
        ...
        if (!is_null($startIndex) && ($startIndex < 1)) {
            throw new \InvalidArgumentException('invalid value for $startIndex when calling PageFeedItemServiceJobStatusSelector., must be bigger than or equal to 1.');
        }
